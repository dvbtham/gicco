...
{
    public class GiccoDbContext : IdentityDbContext<User, Role, long, IdentityUserClaim<long>, UserRole, IdentityUserLogin<long>, IdentityRoleClaim<long>, IdentityUserToken<long>>
    {
        public GiccoDbContext(DbContextOptions options) : base(options)
        {
        }
